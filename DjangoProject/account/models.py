...
class user(models.Model):
  ...
  kakao_email = models.EmailField(null=True, max_length=254, verbose_name="kakao_email", blank=False)
  kakao_name = models.TextField(null=False, verbose_name="kakao_name")
  kakao_id = models.TextField(null=False, verbose_name="kakao_id")
  hashed_id = models.TextField(null=False, verbose_name="hased_kakao_id", default='000')
