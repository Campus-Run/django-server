...
REDIRECT_URI = "http://10.210.60.80:8000/login/kakao/callback"
...
def KakaoSignInCallback(request):
    ...
    data = {
        ...
        'redirection_uri': 'http://10.210.60.80:8000/account/login/kakao/callback',
        'code': CODE,
    }
    ...
    # nodeURL = 'http://10.210.60.80:3000/kakaoLogin'
    # params = {'idToken': hashed_id}
    # res = requests.get(nodeURL, params=params)
    # print("RES", res)
    # if res.status_code == 200:
    #     # return HttpResponse('200')
    #     return redirect('http://10.210.60.80:3000/home')
